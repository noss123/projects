...
from app.routes import api_keys, papers, scripts, slides, media, images, auth, papertovideo, youtube_upload, reels, get_podcast
...
app.include_router(get_podcast.router, prefix="/api/podcast", tags=["Podcast"])

...
/* ───────────────────────────── Results Component ───────────────────────────── */
const Results = () => {
  const { setPaperId, paperId, metadata, videoPath, audioFiles, slides, resetWorkflow, markStepCompleted, completedSteps } = useWorkflow();
  ...
  useEffect(() => {
    setPaperId(paperId);
  }, [paperId]); // ✅ only runs when paperId changes
